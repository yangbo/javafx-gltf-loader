...
public class GLTFNode {
        ...
        throws GLTFException
    {
        ...
        try{
            return new GLTFNode(
                jObj.containsKey("camera") ?
                    jObj.getIntValue("camera")
                    : -1,
                jObj.containsKey("children") ?
                    JSONUtils.JSONToIntArray(jObj.getJSONArray("children"))
                    : null,
                jObj.containsKey("skin") ?
                    jObj.getIntValue("skin")
                    : -1,
                jObj.containsKey("matrix") ?
                    jObj.getJSONArray("matrix")
                    : null,
                jObj.containsKey("mesh") ?
                    jObj.getIntValue("mesh")
                    : -1,
                jObj.containsKey("rotation") ?
                    jObj.getJSONArray("rotation")
                    : null,
                jObj.containsKey("scale") ?
                    jObj.getJSONArray("scale")
                    : null,
                jObj.containsKey("translation") ?
                    jObj.getJSONArray("translation")
                    : null,
                jObj.containsKey("weights") ?
